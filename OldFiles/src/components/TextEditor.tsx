	...
	const addYoutubeVideo = () => {
		...
		if (url) {
			editor.commands.setYoutubeVideo({
				src: url,
				width: Math.max(320, Number.parseInt(width)) || 640,
				height: Math.max(180, Number.parseInt(height)) || 480,
			});
		}
	};

	return (
		<CardHeader className=" rounded-lg border p-2">
			<div className="flex flex-row flex-wrap gap-2">
				...
				<DropdownMenu>
					...
					<DropdownMenuContent className="flex w-56 flex-col gap-2 rounded-lg border bg-background p-2">
						<DropdownMenuItem>
							<Button
